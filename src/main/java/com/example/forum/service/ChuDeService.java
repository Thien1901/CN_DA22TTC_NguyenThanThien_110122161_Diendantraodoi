...
public class ChuDeService {
    ...
    // Khởi tạo dữ liệu mẫu khi ứng dụng chạy (chỉ khi chưa có dữ liệu)
    @PostConstruct
    public void initData() {
        // Chỉ tạo dữ liệu mẫu nếu chưa có chủ đề nào
        if (chuDeRepository.count() == 0) {
    ...
    public void xoaTheoMa(String machude) {
        Optional<ChuDeEntity> chuDeOpt = chuDeRepository.findByMachude(machude);
        chuDeOpt.ifPresent(chuDeRepository::delete);
    }
